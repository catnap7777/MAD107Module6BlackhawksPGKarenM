...
//            ]
//
//var playersArrayConverted = players
//print(playersArrayConverted)

//var players2 = ["DRAKE CAGGIULA": (number:"91",age:"25",bday:"Jun 20, 1994",height:"5'10",country:"CAN"),
//                "RYAN CARPENTER": (number:"22",age:"29",bday:"Jan 18, 1991",hieght:"6'0",country:"USA"),
//                "KIRBY DACH": (number:"77",age:"19",bday:"Jan 21, 2001",height:"6'4",country:"CAN")
//
//    ] as [String : AnyObject]
//
//for (k,v) in players2 {
...
//var Name: String = "kam"
//
//var players3 = [Name:(number:String, age:String, bday:String, height:String, country:String).self] =
//    [   .Ryan:("001","30","Dec 15, 1965", "5'7", "USA")]
//
//var myObject = (number:String,age:String, bday:String, height:String, country:String).self
